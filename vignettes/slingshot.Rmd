...
load('~/Projects/bioc2016singlecell/data/scone_res.rda')
load('~/Projects/bioc2016singlecell/data/rsec_res.rda')
pcaX <- prcomp(t(norm_logcounts), center = TRUE, scale = TRUE)$x[,1:3]
...
```{r curves}
crv <- get_curves(X, clus, l2)
# plot_curves(X, clus, c, threeD = TRUE)
plot_curves(X, clus, crv, dim = 3)
```
